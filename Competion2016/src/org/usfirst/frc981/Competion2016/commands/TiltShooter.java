...
public class TiltShooter extends Command {
    ...
    protected void execute() {
    	double axisAngle = Robot.oi.getShooterControlJoystick().getRawAxis(ShooterSubsystem.AXIS_ID);
    	Robot.shooterSubsystem.setTiltMotorSpeed(axisAngle);
    }
    ...
    protected void end() {
    	Robot.shooterSubsystem.stopTiltMotor();
    }
